...
<section>
    <div id="reservation">
        <center><br/><br/>
        <div class="col-sm-8">
            <img src="img/hotel_reservation.jpg"/>
        </div>
        <h2>Formulaire de réservation</h2><br/>
            <?php
            ...
            {   if( $_POST['venu'] < $_POST['depart']) {
                ...
                $retour = mail('rmacasah@gmail.com', 'Un client vient de réserver sur le site de MACASAH ', $message);
                if ($retour) {
